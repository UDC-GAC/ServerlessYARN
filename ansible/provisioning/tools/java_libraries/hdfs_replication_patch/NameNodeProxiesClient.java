 ...
 */
// PATH: hadoop-hdfs-project/hadoop-hdfs-client/src/main/java/org/apache/hadoop/hdfs
  ...
  public static ClientProtocol createProxyWithAlignmentContext(
    ...
    if (withRetries) { // create the proxy with retries
      ...
      ClientProtocol translatorProxy =
          new ClientNamenodeProtocolTranslatorPB(proxy, conf);
      ...
      // [PATCH]
      return new ClientNamenodeProtocolTranslatorPB(proxy, conf);
    }
  }
